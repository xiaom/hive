...
public class TestEncodedColumnBasedSet {
	...
	public void setUp() throws JSONException {
		//create a TRowSet with one Column, which is of type INT. and has values {0, 1, 2}. and 
	...
	public void positive() throws IOException, JSONException {
		//send the right information as part of compressorInfo. EncodedColumnBasedSet should compress the data.
	...
	public void negative() throws IOException, JSONException {
		//put the wrong information in compressorInfo. EncodedColumnBasedSet should send back the column uncompressed. 
		info.put("vendor", "org.apache.hive.service.cli");
