...
public class SnappyIntCompressor implements ColumnCompressor {
	...
	/**
	  ...
	  /*
	   * Method provided for testing purposes. Decompresses a compressed byte array. should be compressed using 
	   * the compress() function below which uses the snappy JAR files. If Snappy JAR file isn't used, this method 
